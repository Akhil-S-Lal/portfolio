...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "AI & Data Science graduate passionate about solving real-world",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "problems using analytics, modeling, and storytelling",
      "#ffffff"
    )}
${this.wrapWithColor(
      "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
      "   Building scalable and efficient predictive models using",
      "#ffffff"
    )}
${this.wrapWithColor("   Python, SQL, and Power BI", "#ff8c00")}
...
${this.wrapWithColor(
      "   Strong analytical skills with expertise in extracting",
      "#ffffff"
    )}
${this.wrapWithColor("   actionable insights from complex data", "#ffffff")}
...
<span style="color: #00ffff;">Mu Sigma Business Solutions | Decision Scientist</span>
${this.wrapWithColor(
      "Oct 2024 - Jan 2026 | Bengaluru, India",
      "#ffffff"
    )}
${this.wrapWithColor(
      "Improved network reliability resulting in 15% downtime reduction.",
      "#98fb98"
    )}

• ${this.wrapWithColor("Network Analysis", "#ffa07a")} - ${this.wrapWithColor(
      "Built ML models for latency, speed, and congestion analysis.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Agile Tools", "#ffa07a")} - ${this.wrapWithColor(
      "Used Figma and Agile methodologies to ensure delivery.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, SQL, Power BI, Figma, Agile",
      "#87cefa"
    )}

<span style="color: #00ffff;">CodeClause | Data Science Intern</span>
${this.wrapWithColor(
      "Remote, India",
      "#ffffff"
    )}

• ${this.wrapWithColor("Fraud Detection", "#ffa07a")} - ${this.wrapWithColor(
      "Developed robust Credit Card Fraud Detection ML models.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Model Training", "#ffa07a")} - ${this.wrapWithColor(
      "Utilized Jupyter Notebooks for EDA and model training.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Python, Jupyter, Machine Learning, EDA",
      "#87cefa"
    )}

<span style="color: #00ffff;">MedTourEasy | Data Analytics Apprentice</span>
${this.wrapWithColor(
      "Remote, India",
      "#ffffff"
    )}

• ${this.wrapWithColor("Bayesian Analysis", "#ffa07a")} - ${this.wrapWithColor(
      "Conducted analysis comparing handedness lifespan.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Visualization", "#ffa07a")} - ${this.wrapWithColor(
      "Delivered myth-busting analytical conclusions through viz.",
      "#ffffff"
    )}

${this.wrapWithColor("Technologies used:", "#00ffff")} ${this.wrapWithColor(
      "Data Analytics, Bayesian Statistics, Visualization",
      "#87cefa"
    )}`;
...
• ${this.wrapWithColor("AI & Analytics", "#ffffff")}
• ${this.wrapWithColor("Jupyter", "#ffffff")}
...
• ${this.wrapWithColor("VSCode", "#ffffff")}
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:akhilslal007@gmail.com" style="color: #ffffff; text-decoration: none;">akhilslal007@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://akhilslal.github.io" target="_blank" style="color: #ffffff; text-decoration: none;">akhilslal.github.io</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/Akhil-S-Lal" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/Akhil-S-Lal</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://linkedin.com/in/akhil-s-lal-713138217" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/akhil-s-lal-713138217</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  loadProjects() {
    this.projects = [
      {
        title: "SASYA: CropCure",
        description: "An AI-powered web-based system that uses CNNs to identify tomato leaf diseases from images and provides tailored fertilizer recommendations.",
        image: "image/project1-thumb.jpg",
        technologies: ["Python", "TensorFlow", "FastAPI", "React", "Kaggle API"],
        demo: "https://github.com/Akhil-S-Lal/sasya",
        repo: "https://github.com/Akhil-S-Lal/sasya",
      },
      {
        title: "Fraud Detection Engine",
        description: "Created robust Credit Card Fraud Detection models utilizing extensive EDA and imbalance handling techniques.",
        image: "image/project2-thumb.jpg",
        technologies: ["Python", "Scikit", "Jupyter", "Machine Learning"],
        demo: "https://github.com/Akhil-S-Lal",
        repo: "https://github.com/Akhil-S-Lal",
      },
      {
        title: "Lifespan Analysis",
        description: "Conducted Bayesian statistical analysis analyzing whether handedness impacts human lifespan globally.",
        image: "image/project3-thumb.jpg",
        technologies: ["Bayesian Statistics", "Data Analysis", "Python"],
        demo: "https://github.com/Akhil-S-Lal",
        repo: "https://github.com/Akhil-S-Lal",
      },
      {
        title: "Network Prediction",
        description: "Reduced network downtime by 15% through machine learning models identifying potential latency and congestion faults.",
        image: "image/project4-thumb.jpg",
        technologies: ["Machine Learning", "Power BI", "SQL"],
        demo: "https://github.com/Akhil-S-Lal",
        repo: "https://github.com/Akhil-S-Lal",
      }
    ];
  ...
  async generatePDF() {
    const outputElement = this.terminals[this.activeTerminal].input
      .closest(".terminal-content")
      .querySelector("[id^='output']");
    this.printToOutput(outputElement, "Downloading resume...", "info");

    setTimeout(() => {
      const link = document.createElement("a");
      link.href = "Akhil_Shaji_Lal_Resume.pdf?v=2";
      link.download = "Akhil_Shaji_Lal_Resume.pdf";
      link.target = "_blank";
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "akhil@slal: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    role.textContent = "Data Scientist • Machine Learning • AI & Analytics";
    ...
    url.textContent = "akhilslal.github.io";
